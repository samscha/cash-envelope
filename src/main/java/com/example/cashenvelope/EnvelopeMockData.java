...
// // smart home devices "
// // + "that use technology like the Google Assistant. And with the
// availability
// // of maker-friendly "
...
// // "Looking at a landmark and not sure what it is? Interested in learning
// more
// // about a movie as "
// // + "you stroll by the poster? With Google Lens and your Google Assistant,
// you
// // now have a helpful "
// // + "sidekick to tell you more about what’s around you, right on your
// Pixel.",
// // 0.0));
// // envelopes.add(new Envelope(5, "test" "7 ways the Assistant can help youget
// // ready for Turkey Day",
// // "Thanksgiving is just a few days away and, as always, your Google
// Assistant
// // is ready to help. "
// // + "So while the turkey cooks and the family gathers, here are some
// questions
...
// // create envelope
// public Envelope createEnvelope(int id, String name, Double value, String
// notes) {
// Envelope newEnvelope = new Envelope(id, name, value, notes);
